...
from Kichwa.tokens import Token
...
class Function(Expression):
    ...
    def __str__(self) -> str:
        ...
        return f'fshukcion: {params} -> {str(self.type_output)} {str(self.body)} '
...
class Call(Expression):
    ...
    def __init__(self,
                 token: Token,
                 fshukcion: Expression,
                 arguments: Optional[List[Expression]] = None
                 ) -> None:
        super().__init__(token)
        self.fshukcion = fshukcion
    ...
    def __str__(self) -> str:
        ...
        return f'{str(self.fshukcion)}({args})'
